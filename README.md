...
*   For classification: `scikit-learn`

### Code


*   The RL and classification supporting scripts can be found in the *rl_utils* subfolder
*   Train the model and run experiments from the notebook: *grlstop_experiments*
